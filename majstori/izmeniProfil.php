...
?>
  ...
  <body>
    <div id="main" role="main">
      <?php
        $upitProfil = "select * from majstori where ident='$ident' limit 1";
...
<?php
                    if($_POST["lozinka"]){
                      ...
                      $upit = "update majstori set password='$password' where ident='$ident'";
                      $rez = $db -> query($upit);
                      if($rez){
...
<?php
                  if($_POST["podaci"]){
                    ...
                    $opis = $_POST['opis'];
                    $upit = "update majstori set username='$username', ime='$ime', prezime='$prezime', opis='$opis' where ident='$ident'";
                    $rez = $db -> query($upit);
                    if($rez){
...
?>
                  ...
                  <form action="izmeniProfil.php" method="post">
                    ...
                    <section>
                      <label>Opis: </label>
                      <textarea class="input" type="text" name="opis"><?php echo $opis; ?></textarea>
                    </section>
